...
<br><br><center><h1 class="stilo bluefont"><span>Categorías</span></h1></center>
<br><br>
      <!-- <div class="container"> 
        <div class="row">
          <div class="col-sm">
          <a type="button" class="btn btn-outline-success btn-lg botoncatalogo" href="{{ url('/category/Temáticos') }}"><i class="fas fa-star posi greenfont animate"> </i>Temáticos <span class="posi2"> 01</span></a>
          </div><br>
          <div class="col-sm">
            <a type="button" class="btn btn-outline-warning btn-lg botoncatalogo" href="{{ url('/category/Extremos') }}"><i class="fas fa-exclamation-triangle posi yellowfont animate"> </i>Extremos <span class="posi2"> 07</span></a>
          </div>
          <div class="col-sm">
            <a type="button" class="btn btn-outline-danger btn-lg botoncatalogo" href="{{ url('/category/Pantallas_Inflables') }}"><i class="fas fa-desktop posi redfont animate"> </i>Pantallas Inflables <span class="posi2"> 13</span></a>
          </div>
        </div>
        </div> -->
                <div class="row2">
