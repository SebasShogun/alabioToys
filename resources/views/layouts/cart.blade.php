...
<div class="container-fluid"> 
    <br><br>
    <h1 class="stilo bluefont" style="text-align:center;">Mi Carrito</h1><br>
    @if ($emptycart==true)
    ...
    <div class="row">
        ...
        <div class="row" style="background-color:white; padding: 10px !important; box-shadow: 0 5px 5px 0 rgba(0, 0, 0, 0.1), 0 2px 2px 0 rgba(0, 0, 0, 0.1);">
            ...
            <center>
                    ...
                    <label class="btn-sm btn-warning btnrad btn-remove delete1" data-id="{{ $service[7] }}" onclick="deletecart();">Quitar</label>
            </center>
            </div>
            ...
            <div class="col-2 tabla-products">
               <b> ${{number_format(($service[3]*$service[4]),2)}}</b>
            </div>
	    </div>
    @php
        $subtotal=$subtotal+($service[3]*$service[4]);   
    @endphp
    @endforeach
    <div class="row">
        <div class="col-12 letter-total">
            <a class="btn btn-danger" onclick="deleteallcart();" style="color: white;">Vaciar Carrito</a> 
        </div>
    </div>
    </div>
    ...
    <div class="derecha delete1">
            <div class="row total-cuadro" style="background-color:white; border-radius: 5%; box-shadow: 0 5px 5px 0 rgba(0, 0, 0, 0.1), 0 2px 2px 0 rgba(0, 0, 0, 0.1);">
                <div class="col-12 title-total" style="padding-top:2%; padding-bottom:1%; text-align:center;">
                   <b class="letter-total"><span >Total del Carrito</span></b>
                </div>
                ...
                @if($coupon == 0)
                    <div class="input-group mb-3">
                        <input id="couponcode" type="text" class="form-control" placeholder="Ingresa tu código de descuento" maxlength="10" onkeyup="javascript:this.value=this.value.toUpperCase();">
                        <button class="btn btn-danger" type="button" id="validatebuttom"  onclick="validatecoupon();">Aplicar</button>
                    </div>
                @endif
                </div>
                <br>
                ...
                <div class="col-12 letter-total">
                    <a class="btn boton-compra" style="width: 100%;" onclick="validship();"> Realizar Pedido</a><br><br>
                </div>
        ...
        <div class="row" style="background-color:white; box-shadow: 0 5px 5px 0 rgba(0, 0, 0, 0.1), 0 2px 2px 0 rgba(0, 0, 0, 0.1);">
            <div class="col-2 letter-products format-pad">
                <center>
                    ...
                    <label class="btn-sm btn-warning btnrad btn-remove letter-products" data-id="{{ $service[7] }}" onclick="deletecart();">Quitar</label>
                </center>
                </div>
            ...
            <div class="col-2 letter-products format-pad">
                ${{number_format(($service[3]*$service[4]),2)}}
            </div>
	    </div>
    @php
        $subtotal=$subtotal+($service[3]*$service[4]);   
    ...
    <div class="row">
        <div class="col-12 letter-total">
            <center>
            <a class="btn btn-danger letter-total" onclick="deleteallcart();" style="color: white;">Vaciar Carrito</a> 
            </center>
        </div>
    </div>
    </div>
    ...
    <!-- <p style="text-align:center; font-weight:bold;">Si cuentas con un cupón ingresalo y válidalo para tu compra</p> -->
        ...
        <div class="container-fluid delete3" style="padding: 0% !important;">
            <div class="row total-square" style="background-color:white; box-shadow: 0 5px 5px 0 rgba(0, 0, 0, 0.1), 0 2px 2px 0 rgba(0, 0, 0, 0.1);">
                ...
                <div class="col-12 letter-total">
                    <div class="input-group mb-3">
                        <input id="couponcode" type="text" class="form-control letter-total" placeholder="Ingresa tu código de descuento" maxlength="10" onkeyup="javascript:this.value=this.value.toUpperCase();">
                        <button class="btn btn-outline-danger letter-total" type="button" id="validatebuttom"  onclick="validatecoupon();">Aplicar</button>
                    </div>
                </div>
                @endif
                <br>
                <div class="col-12">
                    <a class="btn boton-compra letter-total" style="width: 100%;" onclick="validship();"> Realizar Pedido</a><br><br>
                </div>
            ...
            <table class="table table-striped subtotal_Table centrado ocultar_todo">
                <tbody>
                    ...
                    <form>
                        ...
                        <tr>
                            <td colspan="2">
                                <a class="btn boton-compra" style="width: 100%;" onclick="validship();"> Realizar Pedido</a>
                            </td>
                        </tr>
                </tbody>
            </table> 
