...
@section('content')
    ...
    <div class="container" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); background-color:white;">
                ...
                @if ($OneService->price>0)
                    @if($OneService->amount_pue > 0 || $OneService->amount_qro > 0 || $OneService->amount_ver > 0)
                        @if($datetoday > $datepromb && $datetoday < $dateprome)
                            <div class="table">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 my-auto" style="font-size: 10px; padding-right: 0;">
                                        Pagando con tarjeta de crédito, debito o paypal.
                                    </div>
                                    <!--<div class="col-sm-1" style="color:#00a650; font-size: 10px; padding-right: 0;">
                                        20% Desc. Incluido
                                    </div>-->
                        ...
                        @else
                            ...
                            <b style="font-size: 11px; padding-right: 0; font-weight: 500;">&nbsp;&nbsp;  Pagando con tarjeta de crédito, debito o paypal.</b><br> 
        ...
        <!-- PRECIOS -->
            ...
            &nbsp;&nbsp;  Pagando con tarjeta de crédito, debito o paypal.</b><br>
            <b style="font-size: 11px; padding-right: 0; color:gray;">IVA incluido</b><br><br>
       ...
       <div class="container">
            ...
            <div class="row" style="margin-top:10px;">
                ...
                <b class="icon-letras">Tiempo de elaboración: </b>
                        @if ($OneService->amount_pue > 0 || $OneService->amount_qro > 0 || $OneService->amount_ver > 0)
                            <b style="font-weight: bold; font-size:12px; color: black;">Entrega inmediata.</b>
                        @else
                            <strong><b style="font-weight: bold; font-size:13px; color: black;">{{$OneService->web_production_time}} días</b></strong>
                        @endif
                </div>
            </div>
       ...
       <!-- FIN DE ICONOS DE DESCRIPCIÓN -->
        <div class="container-fluid">
            ...
            <div class="col-12">
                <button type="submit" id="add_cart_button" name="add-to-cart" class="btn btn-secondary btn-sm add-to-cart" value="{{$OneService->id}}" onclick="addcart();">Añadir al carrito</button>     
          ...
          <div class="col-12" style="margin-top:10px;">
                <span class="posted_in"style="font-size: 12px" >Categoría: <a href="{{ url('/category/'.str_replace(" ", "_",$mycat->name)) }}" rel="tag">{{$mycat->name}}</a></span>
                        &nbsp &nbsp
  ...
  <div class="col-md fondo f-der" style="background-color: white;">
    ...
    <!-- TABS DE INFORMACIÓN -->
     <div class="tabs">
            ...
            <center><b style="font-size: 18px; font-weight: 700; text-align: center;">¿Qué incluye?</b></center><hr>
            ...
            <center><b style="font-size: 18px; font-weight: 700; text-align: center;">Información de Envío</b></center><hr>
            <div class="col-12">
                <center>
                <p class="icon-letras">
                    ...
                    Si la paquetería no tiene acceso hasta tu domicilio, el paquete llegará a la sucursal más cercana.
                </p> 
                </div>
            </div>
            ...
            <center><b style="font-size: 18px; font-weight: 700; text-align: center;">Formas de pago</b></center><hr>
                <ul style="list-style:none; font-size: 12px;">
                    <li style="text-align: left;"><a href="{{ asset('metodos-pago') }}"><img loading="lazy" src="{{ asset('img/spei.png') }}" class="metodos movil-position" alt="SPEI" title="Transferencias Eléctronicas"></a>&nbsp Transferencias Eléctronicas</li>
...
<!-- 
     <div class="tabordion oculto2">
                ...
                <p class="icon-letras">     
                    ...
                    <div class="car" id="description" itemprop="description" style="text-align: left;">
                        <ul>
                            ...
                            @if($OneService->minage>0 && $OneService->maxage>0)<li>Edad recomendada: {{$OneService->minage}} – {{$OneService->maxage}} años</li>@endif
                            @if($OneService->kids>0)<li>Capacidad de niños: {{$OneService->kids}} niños al mismo tiempo</li>@endif
                        </ul>
                        {!! $OneService->short_desc !!}    
                    </div>
            </article>
        ...
        <section id="section2">
            ...
            <article>
            <center><b style="font-size: 18px; font-weight: 700; text-align: center;">¿Qué incluye?</b></center><br>
        ...
        <section id="section3">
            ...
            <article>
            <center><b style="font-size: 18px; font-weight: 700; text-align: center;">Información de Envío</b></center><br>
            <div class="col-12">
                <center>
                <p class="icon-letras">
                        @foreach ($shippinmethods as $item)
        ...
        <section id="section4">
            ...
            <center><b style="font-size: 18px; font-weight: 700; text-align: center;">Formas de pago</b></center><br>
                <ul style="list-style:none; font-size: 10px;">
                    <li><a href="{{ asset('metodos-pago') }}"><img loading="lazy" src="{{ asset('img/spei.png') }}" class="metodos" alt="SPEI" title="Transferencias Eléctronicas"></a>&nbsp Transferencias Eléctronicas</li>
...
<!-- PRIMER CARRUSEL -->
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="field">
                                    <div class="label">
                                        <h5><i class="fas fa-at"></i> Correo Electrónico:</h5>
                                    </div>
        ...
        <br>
        <center>
            <h1 class="stilo bluefont">Productos que te podrían interesar:</h1><br>
