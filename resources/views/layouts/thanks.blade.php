...
@endphp
			<div class="container" style="background-color:white; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
				...
				<br><br>
					...
					<span class="text-end-checkout">Fecha estimada de envío: <b>{{ $newDate = date("d/m/Y", strtotime($lastdata->delivery_date)) }}.</b> </span> 
					<br><br> 
					@endif
					<div class="container">
					...
					@endphp	
						...
						<div class="row instruc-table">
							<div class="col-12" style="text-align:center;">
								<b>Forma de Pago: </b> <b style="color:#4484CE;">{!! $payment !!}</b> <br>
							</div>
							<br>
							<div class="col-12" style="text-align:center;">
