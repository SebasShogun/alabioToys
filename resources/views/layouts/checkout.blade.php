...
<style type="text/css">
	...
	<div class="present">
        <div class="text-present">
            ...
            <a href="{{ url('/') }}">Inicio</a><b> / Checkout</b>
         </div>
    </div>
	...
	<div class="izquierda">
	<br>
			<b class="title-box" style="text-align:center;">Mi lista de compras:</b>
			...
			<div class="row total-cuadro" style="border-radius: 0.5rem; text-align:left; box-shadow: 0 2px 10px 1px rgba(0, 0, 0, 0.1), 0 2px 2px 0 rgba(0, 0, 0, 0.1);">
				<!-- Envio a domicilio-->
					<div class="col-12 title-box-back">
						<b class="resumen-titulo">Resumen de Compra</b>
					</div>
		...
		<div class="form-outer" style="background-color:white; border-radius: 0 0 0.5rem 0.5rem; box-shadow: 0 10px 10px 1px rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
			<form role="form" action="" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="pk_live_51HiTZnGob5o9zKSdlESghOJNfqaSfhKsZeKqZSyJuaSr2qZ4Y5M2XARQPFkeSypEEmdrnpZJiHyV64SbaimQhexI00gHVmsydN" id="payment-form">
	            ...
	            <div class="page slide-page" id="inputs">	
		            ...
		            <div class="title">
						<br>
						<h1 class="stilo" style="text-align:center;">Dirección de Envío:</h1>
						<p class="letras-direccion" style="text-align:center;">Por favor, ingresa correctamente los datos de la dirección</p>
					</div>
					...
					<div class="row letras-direccion">
						<div class="col-6">
		            		<div class="field">
								<div class="input-group-prepend">
									<span class="input-group-text letras-direccion"><b style="color:red;">* </b><b class="delete1" title="Escribe tu nombre"> Nombre:</b><i class="fas fa-user delete2 iconos"></i></span>
								</div>
		            	...
		            	<div class="col-6">
		            		<div class="field">
								<div class="input-group-prepend">
									<span class="input-group-text letras-direccion"><b style="color:red;">* </b><b class="delete1" title="Escribe tu apellido"> Apellido:</b><i class="far fa-user delete2 iconos"></i></span>
								</div>
						...
						<div class="col-12">
							<div class="field">
								<div class="input-group-prepend">
									<span class="input-group-text letras-direccion"><b class="delete1">Empresa:</b><i class="fas fa-building delete2 iconos"></i></span>
								</div>
						...
						<div class="col-12">
							<div class="field">
								<div class="input-group-prepend">
									<span class="input-group-text letras-direccion"><b style="color:red;">* </b><b class="delete1"> Calle:</b><i class="fas fa-road delete2 iconos"></i></span>
								</div>
						...
						<div class="col-6">
							<div class="field">
								<div class="input-group-prepend">
									<span class="input-group-text letras-direccion"><b style="color:red;">* </b><b class="delete1"> No. Ext:</b><i class="fas fa-hashtag delete2 iconos"></i></span>
								</div>
						...
						<div class="col-6">
							<div class="field">
								<div class="input-group-prepend">
									<span class="input-group-text letras-direccion"><b class="delete1">No. Int:</b><i class="fas fa-hashtag delete2 iconos"></i></span>
								</div>
						...
						<div class="col-12 letras-direccion">
							<div class="field ">
								<div class="input-group-prepend">
									<span class="input-group-text letras-direccion"><b class="delete1">Referencias:</b><i class="fas fa-road delete2 iconos"></i></span>
								</div>
						...
						<div class="col-6">
							<div class="field">
								<div class="input-group-prepend">
									<span class="input-group-text letras-direccion"><b style="color:red;">* </b><b class="delete1"> Colonia:</b><i class="fas fa-compass delete2 iconos"></i></span>
								</div>					    
						...
						<div class="col-6">
							<div class="field">
								<div class="input-group-prepend">
									<span class="input-group-text letras-direccion"><b style="color:red;">* </b><b class="delete1"> Poblado:</b><i class="fas fa-compass delete2 iconos"></i></span>
								</div>	
						...
						<div class="col-6">
							<div class="field">
									<div class="input-group-prepend">
										<span class="input-group-text letras-direccion"><b style="color:red;">* </b><b class="delete1"> Estado:</b><i class="fas fa-compass delete2 iconos"></i></span>
									</div>	
						...
						<div class="col-6">
							<div class="field">
								<div class="input-group-prepend">
										<span class="input-group-text letras-direccion"><b style="color:red;">* </b><b class="delete1"> Código Postal:</b><b class="delete2 iconos">CP</b></span>
								</div>	
						...
						<div class="col-6">
							<div class="field">
								<div class="input-group-prepend">
									<span class="input-group-text letras-direccion"><b style="color:red;">* </b><b class="delete1"> Pais:</b><i class="fas fa-globe-americas delete2 iconos"></i></span>
								</div>
						...
						<div class="col-6">
							<div class="field">
								<div class="input-group-prepend">
										<span class="input-group-text letras-direccion"><b style="color:red;">* </b><b class="delete1"> Teléfono:</b><i class="fas fa-mobile-alt delete2 iconos"></i></span>
								</div>
						...
						<div class="col-12">
							<div class="field">
								<div class="input-group-prepend">
										<span class="input-group-text letras-direccion"><b class="delete1"> Núm Alterno Teléfono:</b><i class="fas fa-mobile-alt delete2 iconos"></i></span>
								</div>
						...
						<div class="col-12 letras-direccion">
							<div class="field ">
								<div class="input-group-prepend">
									<span class="input-group-text letras-direccion"><b style="color:red;">* </b><b class="delete1"> Correo Electrónico:</b><i class="fas fa-at delete2 iconos"></i></span>
								</div>
						...
						<div class="col-12">
							<div class="field">
								<div class="input-group-prepend">
									<span class="input-group-text letras-direccion"><b style="color:red;">* </b><b>Cómo nos contacto:</b></span>
								</div>
								...
								<option value="5" data-specify="0">Recomendación</option>
								<option value="6" data-specify="0">Cliente Frecuente</option>
								...
								<option value="25" data-specify="1">Punto de Venta</option>
								</select>
							</div>	
						</div> 
				...
				<div class="page">
					<br><br>
		            <h1 class="stilo">Selecciona tu Método de Pago</h1>
					<p class="letras-direccion" style="text-align:center;">Por favor, selecciona una opción y selecciona "siguiente"</p><br>
								...
								<div class="card-body">
									...
									<div class="row">
										<div class="col-md-12"><center>
											<button class="btn btn-info" id="card-button">Continuar</button>
											<button hidden class="btn btn-info" id="loading-card-button"><i class="fas fa-spinner fa-spin"></i> Cargando...</button>
										</center></div>
									</div>
									<div class="row">
										<div class="col-md-12">
				...
				<div class="page">
					<br><br>
			        <h1 class="stilo">Revisa y confirma tu compra</h1>
					<br>
					<div class="container">
					...
					<div class="shadow-sm p-3 space-down rounded">
						<div class="row">
							<div class="col-12" style="background-color:#4484CE; border-radius: 0.5rem;">
								<h5 class="confir-pay" style="color:#fff;"><b> Detalle del envío</b></h5>
							</div>
							<br>
							...
							<div class="col-8" style="padding-top:5%;">
								<div class="text-street">
										...
										<br>
										<span id="call"></span><span> No. Ext: </span><span id="noe"></span>
					...
					<div class="shadow-sm p-3 space-down rounded">
						<div class="row">
							<div class="col-12" style="background-color:#4484CE; border-radius: 0.5rem;">
								<h5 class="confir-pay" style="color:#fff;"><b>Detalle del Pago</b></h5>
							</div>
							<br>
							<div class="col-4" style="padding-top:5%;">
							...
							<div class="col-8 instruct-text" style="text-align:left; padding-top:5%;">
								<b>Método de Pago: </b><b style="font-weight: 500" id="pago"></b><br>
								<b>Total a Pagar: </b><b style="font-weight: 500" id="precio"></b>
							</div>
					...
					<div class="field btns">
						<div class="row ancho">
							<div class="col">
					            <a class="prev-2 prev btn anterio"><i class="fas fa-caret-left"></i> Anterior</a>
					        </div>
					        <div class="col">
								<a class="submit btn" id="btn-pagar" onClick="mensaje()">Finalizar</a>
	...
	<div class="container-fluid footer-bottom" style="padding-top: 2%; padding-left: 8%; background-color:white;">
			<h5 style="font-weight: 600; pagging:0%;">Estas comprando en Alabio Toys!</h5>
			<div class="row">
				<div class="col-0.5" style="padding:0%; margin:0%;">
					<i class="fas fa-map-marker-alt fa-3x"></i>
				</div>
				<div class="col-11" style="margin:0%;">
					<b>Puebla Pue. (Matriz)</b><br>
					<b>Teléfono: <a href="tel:2224943993">222 494 3993</a></b>
				</div>
			</div>
			<br>
			<div class="row">
				...
				<div class="col-11" style="margin:0%;">
					<b>Santiago de Querétaro, Qro. (Sucursal)</b><br>
					<b>Teléfono: <a href="tel:4427197317">442 719 7317</a></b>
				</div>
			</div>
				<br>
			<div class="row">
...
if(isChecked){
		...
		}else if($("#paytipe").val() == "PayPal")
		{
			$.ajax({ 
        		...
        		success: function()
        		{				
            		window.location.href = "/paypal/pay/"+$('#selltotal').val();
        		}
    });
