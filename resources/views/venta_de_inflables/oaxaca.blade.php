...
@section('content')
    ...
    <div class="container bg-light" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
        ...
        <div>
            <br>
            <h3 style="text-align: center;">Venta de juegos, Inflables, Acuáticos en Oaxaca</h3><br>
            <h4>Emprendedores de <b>Oaxaca</b>, inicien, expandan o renueven su negocio con los juegos, Infables, Brincolines, Toros Mecánicos, Euro Bungeee, Juegos de Feria, Futbolitos y mucho más...</h4>
        </div>
